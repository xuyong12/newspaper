...
public class tongji2 extends JFrame {
	...
	public tongji2() {
		...
		try {
			model.setDataVector(new view_2().all(), header);
		} catch (SQLException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (name.equals("")) {
					...
					if (view.compare(name)) {
						...
						int j;
						for (j = 0; j < y; j++) {
							String str = (String) table.getValueAt(j, 2);
		...
		button.setBounds(540, 132, 86, 33);
		...
		button_1.setBounds(678, 132, 86, 33);
